...
const kioskTextGroups: Array<{ title: string; description: string; fields: KioskTextField[] }> = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "kiosk_camera_ready_hint", label: "Ajuda antes da câmera", placeholder: "Toque no botão e fique em posição. A foto será tirada automaticamente em 10 segundos.", long: true },
      { key: "kiosk_camera_ready_button", label: "Botão antes da câmera", placeholder: "Capturar em 10s" },
...
const builderTextFields: Record<string, Omit<Extract<BuilderSelection, { type: "text" }>, "type">> = {
  ...
  kiosk_camera_ready_hint: { key: "kiosk_camera_ready_hint", label: "Ajuda antes da câmera", fallback: "Toque no botão e fique em posição. A foto será tirada automaticamente em 10 segundos.", long: true },
  kiosk_camera_ready_button: { key: "kiosk_camera_ready_button", label: "Botão antes da câmera", fallback: "Capturar em 10s" },
